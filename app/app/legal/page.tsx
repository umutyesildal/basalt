...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    toc: "Upgradability",
    body: [
      "Basket parameters — constituents, weights, fee schedule, creator, and metadata hash — cannot change after deployment; no update instruction exists. The on-chain programs themselves remain upgradable. A finalized read-only devnet RPC audit on 2026-09-19 confirmed that all three program upgrade authorities and the separate whitelist configuration authority remain the same single wallet, with no pending whitelist successor. No multisig or timelock is active. Program IDs and authority reads are not proof that deployed program bytes match this source tree. Program logic could change, so this remains a material trust assumption and a mainnet blocker.",
